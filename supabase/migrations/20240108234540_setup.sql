...
AS $$
DECLARE
  project_url TEXT := 'https://vimbyeuhonkmfhvcbbaa.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZpbWJ5ZXVob25rbWZodmNiYmFhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczOTg0MzkzNiwiZXhwIjoyMDU1NDE5OTM2fQ.g0du5yEAW0WrLi68VUBEd4N7itXFoeURa6XeQUMiHW8'; -- full access needed for http request to storage
